...
namespace MissionPlanner
{
    public partial class MainV2 : Form
    {
        ...
        public static bool isModMode { get; set; }
        ...
        private void modPassButton_Click(object sender, EventArgs e)
        {
            if (modPass.Text == "bhimasena7")
            {
                isModMode = true;
                MenuInitConfig.Visible = true;
            }
